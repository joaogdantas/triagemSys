...
import com.triagemsys.TriagemSysBackend.hospital.domain.service.TreatmentService;
...
public class TreatmentController {
    ...
    public ResponseEntity registerTreatment(@RequestBody RegisterTreatmentDTO registerTreatmentDTO) {
